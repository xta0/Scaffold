...
#import "TBCitySBBusinessLogic.h"

@interface TBCitySBViewController ()<TBCitySBBusinessLogicInterface>
{
...
- (void)setLogic:(TBCitySBBusinessLogic *)logic
{
    _logic = logic;
...
- (TBCitySBBusinessLogic* )logic
{
    if (!_logic) {
        _logic = [TBCitySBBusinessLogic new];
        _logic.viewController = self;
    }
    return _logic;
}
