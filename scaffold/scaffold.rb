...
FileUtils.mkdir_p ["#{package_name}/controller", "#{package_name}/model", "#{package_name}/view" ,"#{package_name}/logic","#{package_name}/config"]
FileUtils.mkdir_p ["#{package_name}/datasource", "#{package_name}/delegate", "#{package_name}/item", "#{package_name}/cell"] if type == "-l"
...
#delate 
delegate_class 			= type == "-l" ? "#{clz_prefix}#{package_name}ListViewDataSource" : ""
