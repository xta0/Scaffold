...
@property (assign, nonatomic) BOOL isWebpModelOn;
...
- (void) setWebpModel:(BOOL) is {
    self.isWebpModelOn = is;
}

- (BOOL) isWebpModelOpen {
    return self.isWebpModelOn;
}
